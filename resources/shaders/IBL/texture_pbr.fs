...
vec3 GetNormal()
{
    vec3 tangentNormal = texture(texture_diffuse5,fs_in.TexCoords).xyz * 2.0 - 1.0;
...
void main()
{
    ...
    float metallic = texture(texture_diffuse2,fs_in.TexCoords).r;
    float roughness = texture(texture_diffuse3,fs_in.TexCoords).r;
    float ao = texture(texture_diffuse4,fs_in.TexCoords).r;
